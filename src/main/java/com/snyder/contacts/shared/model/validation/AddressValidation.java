...
public class AddressValidation implements ValidationAlgorithm<Address>
{
	...
	public static final ValidationAlgorithm<String> LINE_1 = new StringValidationBase("Line 1",
	    MAX_ADDRESS_LINE_LENGTH, true);
	public static final ValidationAlgorithm<String> LINE_2 = new StringValidationBase("Line 2",
	    MAX_ADDRESS_LINE_LENGTH, false);
	public static final ValidationAlgorithm<String> LINE_3 = new StringValidationBase("Line 3",
	    MAX_ADDRESS_LINE_LENGTH, false);
	public static final ValidationAlgorithm<String> CITY = new StringValidationBase("City",
	    MAX_CITY_LENGTH, true);
	public static final ValidationAlgorithm<String> POSTAL_CODE = new StringValidationBase(
	    "Postal code", MAX_POSTAL_CODE_LENGTH, true);
	public static final ValidationAlgorithm<String> COUNTRY = new StringValidationBase("Country",
	    MAX_COUNTRY_LENGTH, true);
	public static final ValidationAlgorithm<String> ADDITIONAL_INFO = new StringValidationBase(
	    "Additional Info", MAX_ADDITIONAL_INFO_LENGTH, true);
