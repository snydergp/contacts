...
public class ModifiableContact extends ValidatedApprovedCompositeModifiable<Contact>
{
	...
	/** The Modifiable used to edit the Person subtype fields (first name, last name...) */
	private final ModifiablePerson modifiablePerson;
	/** The Modifiable used to edit the Business subtype field (name) */
	private final ModifiableBusiness modifiableBusiness;
	/** The modifiable used to switch between subtypes */
	private final ValidatedApprovedLeafModifiable<ContactType> typeSelector;
	/** The modifiable used to edit the {@link Contact#getInfo()} field */
	private final ValidatedApprovedLeafModifiable<String> info;
	/** The controls used to add/remove {@link ModifiableAddress}es */
	private final ValidatedListControls<Address, ModifiableAddress> addresses;
	/** The controls used to add/remove {@link ModifiablePhoneNumber}s */
	private final ValidatedListControls<PhoneNumber, ModifiablePhoneNumber> phoneNumbers;
	/** The controls used to add/remove {@link ModifiableEmailAddress}es */
	...
	public ModifiableContact(Contact initial, ModificationApprover approver)
	{
		...
		addresses =
		    new ValidatedListControls<Address, ModifiableAddress>(initial.getAddresses(),
		...
		phoneNumbers =
		    new ValidatedListControls<PhoneNumber, ModifiablePhoneNumber>(
		...
		emailAddresses =
		    new ValidatedListControls<EmailAddress, ModifiableEmailAddress>(
	 ...
	 *         set to {@value ContactType#PERSON}, the {@link ModifiablePerson} instance accessed
	 *         through {@link #getModifiablePerson()} represents the subtype. When type is set to
	 *         {@value ContactType#BUSINESS}, the subtype is represented by the
	 *         {@link ModifiableBusiness} obtained from {@link #getModifiableBusiness()}.
	 */
	...
	/**
	 * Switches the subtype modifiable state to correspond to the selected {@link ContactType}. In
	 * doing so, it ensures that only the currently-selected subtype is attached to the parent
	 * modifiable.
	 * 
	 * @author SnyderGP
	 */
