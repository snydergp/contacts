...
public class ContactListingView implements IsWidget
{
	 ...
	 * 
	 * @param viewModel
	 *            the viewModel this view represents
	 * @param containerHeight
	 *            a state representing the height of the container of this view
	 * @param scrollOffset
	 *            a state representing the top scroll offset of the container of this view
	 */
