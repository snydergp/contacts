...
public class ContactListingViewModelImpl implements ContactListingViewModel
{
	...
	private final MutableNonNullState<Boolean> ascending = new BaseMutableNonNullState<Boolean>(
	    Boolean.TRUE);
	...
	public ContactListingViewModelImpl(Store<ContactSummary> store, ContactSelection selection)
	{
		...
		viewModelStore =
		    new MappingStore<ContactSummary, ContactSummaryViewModel>(store, new ViewModelMapping());
		orderedContacts =
		    new StoreOrderer<ContactSummaryViewModel>(viewModelStore, new AscendingNameComparator());
		contactSummaryMapping =
		    new StoreMapping<Integer, ContactSummaryViewModel>(viewModelStore, new IdMapping());
	...
	private class SortChangeObserver implements StateObserver<Object>
	{
		...
		public void stateChanged(State<? extends Object> state, Object oldValue, Object newValue)
		{
			...
			Comparator<ContactSummaryViewModel> comparator =
			    ascending.get() ? new AscendingNameComparator() : new DescendingNameComparator();
	...
	private class AscendingNameComparator implements Comparator<ContactSummaryViewModel>
	{
		...
		public int compare(ContactSummaryViewModel o1, ContactSummaryViewModel o2)
		{
			...
			return o1.getSummary().toDisplay(currentSort)
			    .compareTo(o2.getSummary().toDisplay(currentSort));
		}
	...
	private class DescendingNameComparator implements Comparator<ContactSummaryViewModel>
	{
		...
		{
			ContactSort currentSort = contactSort.get();
			return o2.getSummary().toDisplay(currentSort)
			    .compareTo(o1.getSummary().toDisplay(currentSort));
		}
	...
	private class SelectionObserver implements StateObserver<Integer>
	{
		...
		@Override
		public void stateChanged(State<? extends Integer> state, Integer oldValue, Integer newValue)
		{
			if (oldValue != null)
			{
