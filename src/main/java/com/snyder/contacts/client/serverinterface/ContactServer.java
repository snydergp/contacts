...
public interface ContactServer
{
	...
	void updateContact(Contact contact, Callback<Void> callback,
	    ErrorHandler<InvalidContactException> errorHandler);

	void deleteContact(int id, Callback<Void> callback,
	    ErrorHandler<InvalidContactException> errorHandler);
